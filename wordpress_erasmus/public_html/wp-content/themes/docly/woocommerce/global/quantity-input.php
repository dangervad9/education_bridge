...
if ( $max_value && $min_value === $max_value ) {
	...
	$labelledby = ! empty( $args['product_name'] ) ? sprintf( __( '%s quantity', 'docly' ), strip_tags( $args['product_name'] ) ) : '';
	?>
	<div class="product-qty">
        ...
        <input
			...
			title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'docly' ); ?>"
			size="4"
